...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  try {
    ...
    // Check for various possible duplicate email messages
    ...
    if (
      ...
      toast('Email already exists', {
        description: 'Please try logging in or use a different email or forgot password.',
      });
      return;
    }
  ...
  try {
    ...
    if (
      ...
      toast('No account found', {
        description: 'Please create account first.',
      });
      return;
    }
